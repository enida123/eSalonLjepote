...
namespace eStudio.WinUI.Rezervacije
{
    public partial class frmRezervacije : Form
    {
        ...
        private readonly APIService aPIService1 = new APIService("Rezervacije2");
        ...
        {
            var result = await aPIService1.Get<List<eStudioLjepote.Model.RezervacijaViewModel>>(null);
