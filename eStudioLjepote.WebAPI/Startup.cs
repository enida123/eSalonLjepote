...
namespace eStudioLjepote.WebAPI
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRezervacijeEdukacije, RezervacijeEdukacijeService>();
            services.AddScoped<IGradovi, GradoviService>();
            services.AddScoped<IRezervacije2, Rezervacija2Service>();

            services.AddScoped<IKlijentiService, KlijentiService>();
            services.AddScoped<IUplate2, Uplate2Service>();
            services.AddScoped<IPlate2, Plata2Service>();
            ...
            services.AddScoped<ICRUDService<Model.VrstaUsluge, object, VrsteUslugeUpsertRequest, VrsteUslugeUpsertRequest>, VrstaUslugeService>();
            services.AddScoped<ICRUDService<Model.VrsteProizvoda, object, VrsteProizvodaUpsert, VrsteProizvodaUpsert>, VrstaProoizvodaService>();
            services.AddScoped<ICRUDService<Model.Edukacija, object, EdukacijeUpsertRequest, EdukacijeUpsertRequest>, EdukacijaService>();
