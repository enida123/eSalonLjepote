...
using Klijent = eStudioLjepote.WebAPI.Database.Klijent;
...
namespace eStudioLjepote.WebAPI.Services_
{
    ...
    public class KlijentiService : IKlijentiService
    {
        ...
        public KlijentiService(_150023Context context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public  Model.Klijent Update(int id, KlijentiUpsertRequest Request)
        {
